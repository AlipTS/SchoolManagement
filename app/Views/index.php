        ...
        <div class="card">
          <div class="card-body">
            ...
            <ul class="icon-data-list">
              <li>
                <div class="d-flex">
                  <img src="<?= base_url(); ?>/images/faces/face1.jpg" alt="user">
                  <div>
              ...
              <li>
                <div class="d-flex">
                  <img src="<?= base_url(); ?>/images/faces/face2.jpg" alt="user">
                  <div>
              ...
              <li>
                <div class="d-flex">
                  <img src="<?= base_url(); ?>/images/faces/face3.jpg" alt="user">
                  <div>
              ...
              <li>
                <div class="d-flex">
                  <img src="<?= base_url(); ?>/images/faces/face4.jpg" alt="user">
                  <div>
              ...
              <li>
                <div class="d-flex">
                  <img src="<?= base_url(); ?>/images/faces/face5.jpg" alt="user">
                  <div>
